...
const (
	...
	BlogService_DeleteingBlog_FullMethodName = "/blog.BlogService/DeleteingBlog"
...
type BlogServiceClient interface {
	...
	DeleteingBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *blogServiceClient) DeleteingBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BlogService_DeleteingBlog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	...
	DeleteingBlog(context.Context, *BlogId) (*emptypb.Empty, error)
...
func (UnimplementedBlogServiceServer) DeleteingBlog(context.Context, *BlogId) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteingBlog not implemented")
}
...
func _BlogService_DeleteingBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlogId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).DeleteingBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlogService_DeleteingBlog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).DeleteingBlog(ctx, req.(*BlogId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteingBlog",
			Handler:    _BlogService_DeleteingBlog_Handler,
		},
	},
